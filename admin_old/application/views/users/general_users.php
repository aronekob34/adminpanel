				...
				<div class="box-body">
					<div class="col-md-6 col-xs-12 be-div-border-right">
						<div class="pull-left col-md-7">
		                    ...
		                    <p class="be-margin-top-25">
		                    	<a class="btn btn-warning be-remove-btn" title="Suspend" onclick="be_open_suspend_form_modal(<?php echo $current_item['user_id']; ?>);"><i class="fa fa-lock"></i> Suspend this user</a>
		                    	&nbsp;&nbsp;&nbsp;
