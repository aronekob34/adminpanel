		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-success">
					<div class="box-header">
						<h3 class="box-title">Businesses List</h3>
					</div>
                            ...
                            <tbody>
								<?php
									...
									foreach($data['businesses'] as $item) {
                                    	$i++;
										$biz_logo_url = $site_info['front_url'] . config_item('path_media_businesses') . $item['biz_logo_url'];
                                        echo '
											<tr>
												<td>' . $i . '</td>
												<td><img src="' . $biz_logo_url . '" width="64" height="64" alt=""></td>
                                        		<td>' . $item['biz_name'] . '</td>
                                        		<td>' . $item['category_name'] . '</td>                                        			
                                        		<td align="center">
                                        			&nbsp;<a href="' . base_url() . $page . '/' . $item['biz_id'] . '" class="btn btn-info be-edit-btn" title="Detail"><i class="fa fa-eye"></i>&nbsp;View Detail</a>&nbsp;                                        				
                                        		</td>
                                        	</tr>
                                        ';
                                    }
		    ...
		    <div class="modal-dialog">
		        ...
		        <div class="modal-content">
		            ...
		            <div class="modal-body">
		            	...
		            	Are you sure to suspend this user?</h4>
		            </div>
		            <div class="modal-footer">
		            	<button type="button" class="btn btn-primary" data-dismiss="modal">Cancel</button>
